...
function Login() {
  ...
  // The onSubmit function needs to be defined
      ...
      <div>
        <dialog id="my_modal_3" className="modal">
          <div className="modal-box">
            {/* The form now correctly references the onSubmit function */}
            <form onSubmit={handleSubmit(onSubmit)} method="dialog">
              ...
              <div className='mt-4 space-y-2'>
                <span>Password</span>
                <br />
                {/* The input type should be "password" instead of "text" for security */}
